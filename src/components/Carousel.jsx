  ...
  switch (type) {
    ...
    case 3:
      return (
        ...
        >
          <div className={`w-full h-full flex flex-col-reverse ${type === 2 ? 'md:flex-row' : 'md:flex-row-reverse' }  sm:gap-8 justify-end xl:gap-16 md:items-center`}>
            ...
            <img
              className="md:w-5/12 max-h-[288px] object-cover my-4 rounded"
              src={image}
            />
          </div>
        </div>
